...
namespace InfoStore.Data.Migrations
{
    ...
    [Migration("20221221090539_BokkmarksUserId")]
    partial class BokkmarksUserId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InfoStore.Data.Entities.Bookmark", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InfoStore.Data.Entities.Group", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("InfoStore.Data.Entities.Note", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BookmarkTag", b =>
                {
                    b.HasOne("InfoStore.Data.Entities.Bookmark", null)
                        .WithMany()
                        .HasForeignKey("BookmarksId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InfoStore.Data.Entities.Tag", null)
                        .WithMany()
            ...
            modelBuilder.Entity("InfoStore.Data.Entities.Bookmark", b =>
                {
                    b.HasOne("InfoStore.Data.Entities.Group", "Group")
                        .WithMany("Bookmarks")
